...
public class MenuXml
{
    ...
    public static MenuNode parse(@NonNull Context context, @NonNull String asset) {
        try {
    ...
    public static MenuNode parse(@NonNull InputStream stream)
    {
        try {
    ...
    public static MenuNode parse(@NonNull XmlPullParser parser) throws
        IOException, XmlPullParserException
    {
        ...
        while (eventType != END_DOCUMENT)
        {
            if (eventType == START_TAG)
            {
                ...
                MenuNode node = new MenuNode(name, link, parser.getName());
